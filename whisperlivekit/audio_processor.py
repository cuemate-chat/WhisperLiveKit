...
class AudioProcessor:
    ...
    def __init__(self, **kwargs):
        ...
        self.max_bytes_per_sec = 32000 * 5  # 5秒音频
        ...
        # 在线处理器
        self.online_asr = online_factory(self.args, self.asr, self.tokenizer)
        self.online_diarization = online_diarization_factory(self.args, models.diarization_backend) if self.args.diarization else None
        self.online_translation = online_translation_factory(self.args, models.translation_model) if self.args.target_language else None
    ...
    async def transcription_worker(self):
        ...
        while True:
            try:
                ...
                # 处理转录
                output = self.online_asr.process_iter(audio_chunk)
                for o in output:
                    if o is None:
                        continue
